...
namespace WebApplication2.Migrations
{
    ...
    [Migration("20260909180218_AddedTwoFactorChallenge")]
    partial class AddedTwoFactorChallenge
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication2.Models.Auth.TwoFactorChallenge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApplication2.Models.Profile.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("DealsAndCoupons")
                        .HasColumnType("boolean");

                    b.Property<bool>("PriceDrops")
                        .HasColumnType("boolean");

                    b.Property<bool>("Recommendations")
                        .HasColumnType("boolean");

                    b.Property<DateTime>("UpdatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("WatchListSales")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("WebApplication2.Models.Profile.PriceAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApplication2.Models.Profile.SavedAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid>("SavedCustomerId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApplication2.Models.Profile.StockAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApplication2.Models.Profile.TwoFactorAuth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApplication2.Models.Profile.NotificationPreference", b =>
                {
                    b.HasOne("WebApplication2.Models.Auth.Customer", "Customer")
                        ...
                        .HasForeignKey("WebApplication2.Models.Profile.NotificationPreference", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication2.Models.Profile.SavedAccount", b =>
                {
                    ...
                    b.HasOne("WebApplication2.Models.Auth.Customer", "SavedCustomer")
                        .WithMany("SavedByAccounts")
                        .HasForeignKey("SavedCustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Customer");

                    b.Navigation("SavedCustomer");
                });
